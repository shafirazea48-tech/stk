            ...
            return (
              ...
              >
                ...
                {isActive && (
                  ...
                  >
                    <path d="M3 8l3.5 3.5L13 5" stroke="#0c8df8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                )}
              </a>
            );
...
export default function Header({ locale }: { locale?: Locale }) {
  ...
  return (
    <>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "0.694444vw", flexShrink: 0, marginLeft: "auto" }}>
            ...
            >
              <img
                ...
                alt={activeLang.code}
                style={{ height: "1.85185vw", minHeight: 20, width: "auto", borderRadius: 3 }}
              />
            </button>
          </div>
        </div>
      ...
      {/* Language panel — rendered outside header to avoid stacking context issues */}
      {langPanelOpen && (
        <LanguagePanel locale={locale} onClose={() => setLangPanelOpen(false)} />
      )}
    </>
  );
}

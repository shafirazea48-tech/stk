...
const SocialIcon = ({ name, href, icon }: { name: string; href: string; icon: React.ReactNode }) => (
  ...
  >
    <span style={{ display: "flex", width: "1.04167vw", height: "1.04167vw" }}>{icon}</span>
  </a>
);
    ...
    <footer style={{ background: "#000" }}>
      ...
      >
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.277778vw" }}>
              <p style={{ fontSize: "0.694444vw", color: "#82889b" }}>Email</p>
              <a
                href="mailto:support@stockity.com"
                style={{ fontSize: "0.810185vw", color: "#f4f4f6", textDecoration: "none" }}
              >
                support@stockity.com
              </a>
            </div>
            ...
            {/* Address */}
            <div style={{ display: "flex", flexDirection: "column", gap: "0.277778vw" }}>
              <p style={{ fontSize: "0.810185vw", color: "#f4f4f6", fontWeight: 600 }}>
                VERTE SECURITIES LIMITED
              </p>
              <p style={{ fontSize: "0.694444vw", color: "#82889b", lineHeight: 1.6 }}>
                International Business Centre, Suite 8, Pot 820/104, Route Elluk, Port Vila, Vanuatu
              </p>
            </div>

            {/* Reg No */}
            <p style={{ fontSize: "0.810185vw", color: "#82889b" }}>Reg No. 700726</p>
        ...
        <div style={{ borderTop: "1px solid rgba(255,255,255,0.06)", paddingTop: "1.62037vw" }}>
          ...
          <p style={{ fontSize: "0.694444vw", color: "rgba(130,136,155,0.6)" }}>
            © 2022-2026 Stockity. All rights reserved
          </p>
        </div>
      </div>

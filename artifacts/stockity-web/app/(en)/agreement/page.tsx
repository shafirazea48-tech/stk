    ...
    <>
      ...
      >
        ...
        >
          ...
          <p style={pStyle}>
            Pursuant to the terms and conditions set forth in this Client Agreement (the
            &apos;Agreement&apos;), Verte Securities Limited, a company registered in accordance
            with the laws of the Republic of Vanuatu, company number 700726, whose registered
            office is located at International Business Centre, Suite 8,Pot 820/104, Route Elluk,
            Port Vila, Vanuatu (the &apos;Company&apos;) grants an individual person (the
            &apos;Client&apos;) access to the{" "}
            <a href="http://stockity.com" target="_blank" rel="noopener noreferrer" style={linkStyle}>
              stockity.com
            </a>{" "}
            website (the &apos;Website&apos;) and Stockity mobile application (the &apos;Mobile
            Application&apos;) for the purpose of executing trading transactions involving financial
            instruments provided on the Website. Except where expressly stated otherwise, all
            services rendered by the Company via the Website are equally accessible through the
            Mobile Application.
          </p>
          <p style={pStyle}>The place of services provision shall be the Republic of Vanuatu.</p>
          <p style={pStyle}>
            Through registration on the Website, the Client acknowledges acceptance of the
            Agreement and{" "}
            <a href="/privacy" style={linkStyle}>
              the Privacy Policy
            </a>{" "}
            that is available on the Website and is an integral part of the Agreement. Such
            acceptance constitutes full and unconditional consent to all provisions hereof.
          </p>

          {/* I */}
          <h2 style={h2Style}>I. DEFINITIONS</h2>
          {[
          ...
          {/* II */}
          <h2 style={h2Style}>II. REGISTRATION AND VERIFICATION</h2>
          {[
          ...
          {/* III */}
          <h2 style={h2Style}>III. FTT TRADING (FIXED TIME TRADES)</h2>
          {[
          ...
          {/* IV */}
          <h2 style={h2Style}>IV. 5ST TRADING</h2>
          {[
          ...
          {/* V */}
          <h2 style={h2Style}>V. CFD TRADING</h2>
          {[
          ...
          {/* VI */}
          <h2 style={h2Style}>VI. PREDICTION TRADING</h2>
          <p style={pStyle}><strong style={{ color: "#f4f4f6" }}>6.1.</strong> To open a Trade, the Client selects the event, specifies the investment amount, and chooses either &quot;yes&quot; or &quot;no&quot;.</p>
          <p style={pStyle}><strong style={{ color: "#f4f4f6" }}>6.2.</strong> Trade closes either by Client instruction to sell the Event Contract or automatically upon reaching the time or occurrence of an event indicated in the Event Contract.</p>
          <p style={pStyle}><strong style={{ color: "#f4f4f6" }}>6.3.</strong> A Trade is profitable if, at closing upon reaching the time indicated in the Event Contract, the event has occurred when the chosen option was &quot;yes&quot;, or event has not occurred when the chosen option was &quot;no.&quot;</p>

          {/* VII */}
          <h2 style={h2Style}>VII. TRADING TRANSACTIONS</h2>
          <p style={pStyle}><strong style={{ color: "#f4f4f6" }}>7.1.</strong> Quotes on the Trading Platform are delivered from an external data feed in real time and may be incomplete due to connectivity issues. The Company does not guarantee execution at the Quote shown at the time the Trading Order is placed.</p>
          <p style={pStyle}><strong style={{ color: "#f4f4f6" }}>7.1.2.</strong> Asset Quotation on the Trading Platform is calculated as the arithmetic mean of the purchase and sale prices: (purchase + sale) / 2.</p>
          <p style={pStyle}><strong style={{ color: "#f4f4f6" }}>7.2.</strong> Processing of Client&apos;s Trading Orders: (i) the Client executes a Trading Order, validated on the Trading Platform; (ii) the validated order is transmitted to the Company Server; (iii) upon successful verification, the Server processes the order and communicates the outcome back to the Trading Platform.</p>
          <p style={pStyle}><strong style={{ color: "#f4f4f6" }}>7.3.</strong> Processing time depends on communication quality and market conditions. Under normal circumstances, processing requires 0–4 seconds.</p>
          <p style={pStyle}><strong style={{ color: "#f4f4f6" }}>7.4.1.</strong> Minimum investment per Trade is $1/€1 or equivalent of $1; maximum is $5,000/€5,000 or equivalent of $5,000.</p>
          <p style={pStyle}><strong style={{ color: "#f4f4f6" }}>7.6.</strong> AI Trading is available only on the Real Account and only for FTT (Fixed Time Trades). AI Trades are open and closed automatically without any prior consultation, consent or approval of the Client. The Client can stop the AI Trading session at any time through the &apos;AI Stop&apos; button.</p>
          <p style={pStyle}><strong style={{ color: "#f4f4f6" }}>7.8.</strong> The Company may restrict the maximum number of Trades per Client within defined intervals (minute, hour, day).</p>
          <p style={pStyle}><strong style={{ color: "#f4f4f6" }}>7.9.</strong> The Company reserves the right to add, modify, or remove Assets and/or Event Contracts, amend profitability percentages, minimum and maximum investment amounts, and Expiration terms for one or multiple Assets.</p>

          {/* VIII */}
          <h2 style={h2Style}>VIII. NON-TRADING TRANSACTIONS</h2>
          <p style={pStyle}><strong style={{ color: "#f4f4f6" }}>8.1.</strong> Official methods for Deposits and Withdrawals are set forth on the Company&apos;s Website. The Client bears all risks related to payment system usage, including commissions and currency conversion fees. Applicable withdrawal commissions by jurisdiction:</p>
          <ul style={{ paddingLeft: 24, margin: "0 0 1em" }}>
            {["India: 10% commission for all withdrawal requests above the limit of 1 within 24 hours", "Indonesia: 5% commission for all withdrawal requests above the limit of 1 within 24 hours", "Ukraine: 2% commission for all withdrawal requests above the limit of 1 within 24 hours", "Vietnam: 10% commission for all withdrawal requests above the limit of 1 within 24 hours"].map(t => <li key={t} style={liStyle}>{t}</li>)}
          </ul>
          {[
          ...
          {/* IX */}
          <h2 style={h2Style}>IX. BONUSES, TOURNAMENTS AND PROMOTIONS</h2>
          {[
          ...
          {/* X */}
          <h2 style={h2Style}>X. MARKET</h2>
          <p style={pStyle}><strong style={{ color: "#f4f4f6" }}>10.1.</strong> The Client acknowledges that materials in the Market do not constitute investment or trading advice; all trading decisions are at the Client&apos;s sole discretion, and the Company disclaims liability for direct, indirect, or any other losses arising from Market information.</p>
          <p style={pStyle}><strong style={{ color: "#f4f4f6" }}>10.9.</strong> Violation of the Agreement terms by the Client may result in the Company restricting the Client&apos;s Market access at its sole discretion.</p>

          {/* XI */}
          <h2 style={h2Style}>XI. STOCKENS</h2>
          {[
          ...
          {/* XII */}
          <h2 style={h2Style}>XII. CLIENT RISKS</h2>
          <p style={pStyle}><strong style={{ color: "#f4f4f6" }}>12.1.</strong> The Client fully acknowledges that: (i) trading in financial instruments involves significant risks; prior financial capacity assessment is advised; (ii) Trading Transactions conducted via the Trading Platform are over-the-counter, not exchange-traded, and carry higher risks; (iii) information or recommendations from the Company or partners do not constitute direct offers to trade; (iv) technical failures, unstable internet connection, power outages, or other factors may cause the Client financial losses.</p>
          <p style={pStyle}><strong style={{ color: "#f4f4f6" }}>12.2.</strong> The Client assumes all risks regarding legal restrictions in their jurisdiction and bears responsibility for compliance.</p>
          <p style={pStyle}><strong style={{ color: "#f4f4f6" }}>12.3.</strong> The Company does not guarantee Client profits or absence of losses from use of its services.</p>

          {/* XIII */}
          <h2 style={h2Style}>XIII. GUARANTEES, LIABILITY, AND FORCE MAJEURE</h2>
          {[
          ...
          {/* XIV */}
          <h2 style={h2Style}>XIV. DISPUTE RESOLUTION</h2>
          {[
            ...
            <p key={num} style={pStyle}>
              <strong style={{ color: "#f4f4f6" }}>{num}</strong>{" "}
              {num === "14.1." ? (
                <>The Client shall first address disputes to the Company Support. If unsatisfied, the Client may submit a complaint via email{" "}
                  <a href="mailto:complaints@stockity.com" style={linkStyle}>complaints@stockity.com</a>.</>
              ) : text}
            </p>
          ))}

          {/* XV */}
          <h2 style={h2Style}>XV. CONTACTS</h2>
          <p style={pStyle}><strong style={{ color: "#f4f4f6" }}>15.1.</strong> The Client may contact the Company via: (i) email{" "}
            <a href="mailto:support@stockity.com" style={linkStyle}>support@stockity.com</a>; (ii) online chat on the Website.</p>
          <p style={pStyle}><strong style={{ color: "#f4f4f6" }}>15.2.</strong> The Client&apos;s contact details include their registered email and optionally a phone number provided in their Personal Account.</p>

          {/* XVI */}
          <h2 style={h2Style}>XVI. TAXES</h2>
          <p style={pStyle}>The Company is not a tax agent and does not disclose Client transactions data except upon official request by competent authorities.</p>

          {/* XVII */}
          <h2 style={h2Style}>XVII. VALIDITY AND TERMINATION. AMENDMENT</h2>
          {[
          ...
          {/* XVIII */}
          <h2 style={h2Style}>XVIII. FINAL PROVISIONS</h2>
          <p style={pStyle}><strong style={{ color: "#f4f4f6" }}>18.1.</strong> The Client may not assign rights or obligations under the Agreement to third parties.</p>
          <p style={pStyle}><strong style={{ color: "#f4f4f6" }}>18.2.</strong> In case of discrepancies, the English version prevails over translations.</p>
          <p style={pStyle}><strong style={{ color: "#f4f4f6" }}>18.3.</strong> This Agreement is governed by the laws of the Republic of Vanuatu.</p>
        </div>
      </main>
    </>
  );

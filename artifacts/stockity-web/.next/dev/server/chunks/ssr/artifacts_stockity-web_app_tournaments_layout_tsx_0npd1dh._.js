module.exports = [
"[project]/artifacts/stockity-web/app/tournaments/layout.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const metadata = {
    ...
    description: "Join Stockity trading tournaments — compete with other traders, trade 5 regional indices with boosted profitability, and climb the rankings.",
    alternates: {
        canonical: "/tournaments"
    },
    openGraph: {
        title: "Trading Tournaments | Stockity",
        description: "Compete in Stockity trading tournaments. Trade regional indices with boosted profitability.",
        url: "/tournaments"
    }
};
function TournamentsLayout({ children }) {
...
"[project]/artifacts/stockity-web/app/tournaments/layout.tsx [app-rsc] (ecmascript, Next.js Server Component)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/artifacts/stockity-web/app/tournaments/layout.tsx [app-rsc] (ecmascript)"));
}),
];

//# sourceMappingURL=artifacts_stockity-web_app_tournaments_layout_tsx_0npd1dh._.js.map